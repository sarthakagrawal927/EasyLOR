...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  createLORApplication?: Resolver<ResolversTypes['LORApplication'], ParentType, ContextType, RequireFields<MutationCreateLorApplicationArgs, 'dueDate' | 'statementOfPurpose' | 'course' | 'university' | 'studentID' | 'facultyID'>>;
